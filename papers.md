...
|---|---|---|---|---|---|---|---|
| MA-001 | 多 Agent | NeurIPS 2025 D&B | Why Do Multi-Agent LLM Systems Fail? | TO_READ | skimmed | [导读](notes/multi-agent/why-mas-fail.md) | 已核验表 5 与附录 H；审阅等预算验证设计，固定数据和模型版本 |
